export const defaults = {
    ...
    syncInterval: 512,
    storage: `${process.env.PHANTOM_PATH_DATA}/database/transaction-pool-${process.env.PHANTOM_NETWORK_NAME}.sqlite`,
    ...
    allowedSenders: [],
    maxTransactionsPerRequest: process.env.PHANTOM_TRANSACTION_POOL_MAX_PER_REQUEST || 40,
