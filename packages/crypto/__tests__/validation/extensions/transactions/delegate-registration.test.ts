...
describe("Delegate Registration Transaction", () => {
    it("should be valid", () => {
        ...
        expect(validator.validate(transaction.getStruct(), validator.phantomDelegateRegistration()).error).toBeNull();
    });

    it("should be invalid due to no transaction as object", () => {
        expect(validator.validate("test", validator.phantomDelegateRegistration()).error).not.toBeNull();
    });
    ...
    it("should be invalid due to non-zero amount", () => {
        ...
        expect(
            validator.validate(transaction.getStruct(), validator.phantomDelegateRegistration()).error,
        ).not.toBeNull();
    });
