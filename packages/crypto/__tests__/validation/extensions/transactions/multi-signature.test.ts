...
describe("Multi Signature Transaction", () => {
    it("should be valid with min of 3", () => {
        ...
        expect(validator.validate(transaction.getStruct(), validator.phantomMultiSignature()).error).toBeNull();
    });
    ...
    it("should be invalid due to no transaction as object", () => {
        expect(validator.validate("test", validator.phantomMultiSignature()).error).not.toBeNull();
    });
    ...
    it("should be invalid due to non-zero amount", () => {
        transaction
            ...
            .sign("passphrase");
        signTransaction(transaction, passphrases);
        expect(validator.validate(transaction.getStruct(), validator.phantomMultiSignature()).error).not.toBeNull();
    });
    ...
    it("should be invalid due to wrong transaction type", () => {
        ...
        expect(validator.validate(transaction.getStruct(), validator.phantomMultiSignature()).errors).not.toBeNull();
    });
});
