...
describe('Transfer Transaction', () => {
  describe('verify', () => {
    it('should be valid with a signature', () => {
      const actual = builder
        .recipientId('P9HCANgSyGYuk8ya1jJ2UQnPDKHfHSdSFU')
        .amount(1)
        .vendorField('dummy')
  ...
  describe('signWithWif', () => {
    it('should sign a transaction and match signed with a passphrase', () => {
      ...
      const wif = crypto.keysToWIF(keys, { wif: 187 })
      ...
      wifTransaction.signWithWif(wif, 187)
  ...
  describe('secondSignWithWif', () => {
    it('should sign a transaction and match signed with a passphrase', () => {
      ...
      wifTransaction.secondSignWithWif(wif, 187)
