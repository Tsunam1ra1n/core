...
const wif = crypto.keysToWIF(crypto.getKeys(passphrase), { wif: 187 })
const signedMessageEntries = [
  [
    'publicKey',
    '03bb51bbf5bf84759452e33dd97cf72cc8904be07df07a946a0d84939400f17e87',
  ],
  [
    'signature',
...
describe('Message', () => {
  describe('sign', () => {
    ...
    it('should sign a message', () => {
      expect(Message.sign('test', passphrase)).toContainAllEntries(
  ...
  describe('signWithWif', () => {
    ...
    it('should sign a message', () => {
      expect(Message.signWithWif('test', wif)).toContainAllEntries(
        signedMessageEntries,
      )
    })
