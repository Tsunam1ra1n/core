...
describe('HDWallet', () => {
  describe('bip32', () => {
    it('can create a BIP32 wallet external address', () => {
      ...
      expect(crypto.getAddress(child1.publicKey.toString('hex'))).toBe(
        'AZXdSTRFGHPokX6yfXTfHcTzzHKncioj31',
      )
      expect(crypto.getAddress(child2.publicKey.toString('hex'))).toBe(
        'AZXdSTRFGHPokX6yfXTfHcTzzHKncioj31',
      )
    })
  })
  ...
  describe('bip44', () => {
    it('can create a BIP44, ark, account 0, external address', () => {
      ...
      expect(crypto.getAddress(child1.publicKey.toString('hex'))).toBe(
        'AKdstZSrxzeF54e1M41fQzqGqjod9ydG3E',
      )
      expect(crypto.getAddress(child2.publicKey.toString('hex'))).toBe(
        'AKdstZSrxzeF54e1M41fQzqGqjod9ydG3E',
      )
  ...
  describe('deriveSlip44', () => {
    ...
    it('should derive path', () => {
      ...
      expect(crypto.getAddress(actual.publicKey.toString('hex'))).toBe(
        'AHQhEsLWX5BbvvK836f1rUyZZZ77YikYq5',
      )
  ...
  describe('deriveNetwork', () => {
    ...
    it('should derive path', () => {
      ...
      expect(crypto.getAddress(actual.publicKey.toString('hex'))).toBe(
        'AKjBp5V1xG9c5PQqUvtvtoGjvnyA3wLVpA',
      )
      expect(actual.publicKey.toString('hex')).toBe(
