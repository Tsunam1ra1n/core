...
describe('crypto.js', () => {
  ...
  describe('getHash', () => {
    ...
    it('should return Buffer and Buffer most be 32 bytes length', () => {
      ...
      expect(result.toString('hex')).toBe(
        '952e33b66c35a3805015657c008e73a0dee1efefd9af8c41adb59fe79745ccea',
      )
    })
  })
  ...
  describe('keysToWIF', () => {
    ...
    it('should get keys from WIF', () => {
      const wifKey = 'UgSJ3cLvUy6idz2ZBitXUQx4HXCEHbXcpY6ezChQn3pPdrjbTAbJ'
  ...
  describe('getAddress', () => {
    ...
    it('should generate address by publicKey', () => {
      ...
      expect(address).toBe('PBKj8VaW61XRWcmnmC1zTnvMfApJ9RyMu2')
    })
    ...
    it('should generate address by publicKey - second test', () => {
      ...
      expect(address).toBeString()
      expect(address).toBe('PHG94GGzfVqJMCYfidiWfEthMihUFhN8Rx')
    })
  ...
  describe('validate address on different networks', () => {
    ...
    it('should validate DEVNET addresses', () => {
      ...
      expect(
        crypto.validateAddress('PDsnvZA1SKcFLw68X9oDXYAa6b1BiPoDhZ'),
      ).toBeTrue()
    })
  })
})
