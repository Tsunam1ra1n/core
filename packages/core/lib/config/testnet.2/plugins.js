module.exports = {
  ...
  '@phantomchain/core-logger-winston': {
    transports: {
      ...
      dailyRotate: {
        options: {
          filename: process.env.PHANTOM_LOG_FILE || `${process.env.PHANTOM_PATH_DATA}/logs/core/${process.env.PHANTOM_NETWORK_NAME}.2/%DATE%.log`,
  ...
  '@phantomchain/core-database': {
    snapshots: `${process.env.PHANTOM_PATH_DATA}/${process.env.PHANTOM_NETWORK_NAME}.2/snapshots`
  },
  '@phantomchain/core-database-sequelize': {
    dialect: 'sqlite',
    storage: process.env.PHANTOM_DB_STORAGE || `${process.env.PHANTOM_PATH_DATA}/database/${process.env.PHANTOM_NETWORK_NAME}.2.sqlite`,
    ...
    // database: process.env.PHANTOM_DB_DATABASE || 'phantom_testnet2',
  ...
  '@phantomchain/core-database-postgres': {
    connection: {
      ...
      database:
        process.env.PHANTOM_DB_DATABASE || `ark_${process.env.PHANTOM_NETWORK_NAME}2`,
  ...
  '@phantomchain/core-p2p': {
    ...
    port: process.env.PHANTOM_P2P_PORT || 4202,
  ...
  '@phantomchain/core-api': {
    ...
    port: process.env.PHANTOM_API_PORT || 4203,
    whitelist: ['*']
  },
  '@phantomchain/core-webhooks': {
    ...
    database: {
      dialect: 'sqlite',
      storage: `${process.env.PHANTOM_PATH_DATA}/database/${process.env.PHANTOM_NETWORK_NAME}.2/webhooks.sqlite`,
      logging: process.env.PHANTOM_DB_LOGGING
    },
    redis: {
      host: process.env.PHANTOM_REDIS_HOST || 'localhost',
  ...
  '@phantomchain/core-graphql': {
    ...
    port: process.env.PHANTOM_GRAPHQL_PORT || 4205,
    path: '/graphql',
    graphiql: true,
  },
