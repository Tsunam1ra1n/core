module.exports = {
  ...
  '@phantomchain/core-logger-winston': {
    transports: {
      ...
      dailyRotate: {
        options: {
          filename: process.env.PHANTOM_LOG_FILE || `${process.env.PHANTOM_PATH_DATA}/logs/core/${process.env.PHANTOM_NETWORK_NAME}.live/%DATE%.log`,
  ...
  '@phantomchain/core-database': {
    snapshots: `${process.env.PHANTOM_PATH_DATA}/${process.env.PHANTOM_NETWORK_NAME}.live/snapshots`
  },
  '@phantomchain/core-database-sequelize': {
    dialect: 'sqlite',
    storage: process.env.PHANTOM_DB_STORAGE || `${process.env.PHANTOM_PATH_DATA}/database/${process.env.PHANTOM_NETWORK_NAME}.live.sqlite`,
  ...
  '@phantomchain/core-database-postgres': {
    connection: {
      ...
      database:
        ...
        || `ark_${process.env.PHANTOM_NETWORK_NAME}live`,
  ...
  '@phantomchain/core-webhooks': {
    ...
    database: {
      dialect: 'sqlite',
      storage: `${process.env.PHANTOM_PATH_DATA}/database/${process.env.PHANTOM_NETWORK_NAME}.live/webhooks.sqlite`,
      logging: process.env.PHANTOM_DB_LOGGING
    },
    redis: {
      host: process.env.PHANTOM_REDIS_HOST || 'localhost',
